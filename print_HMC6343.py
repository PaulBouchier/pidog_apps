...
##  Constants
    ...
    def __init__(self, mode=None, orientation=None):
        super().__init__(address=self.I2C_ADDR)
    ...
    def readHeading(self):
        sleep(self.TD_DEFAULT)
        self.write(self.POST_HEADING)
        sleep(self.TD_POST_DATA)
        readValues = self.read(length=self.BLEN_POST_DATA)
        ...
        print("Heading = %f pitch = %f roll = %f heading[0]: %d heading[1]: %d" %(heading, pitch, roll, readValues[0], readValues[1]))
        return heading
